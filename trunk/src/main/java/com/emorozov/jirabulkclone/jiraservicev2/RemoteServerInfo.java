...
public class RemoteServerInfo  implements java.io.Serializable {
    ...
    private com.emorozov.jirabulkclone.jiraservicev2.RemoteTimeInfo serverTime;
    ...
    public RemoteServerInfo(
           ...
           com.emorozov.jirabulkclone.jiraservicev2.RemoteTimeInfo serverTime,
     ...
     * @return serverTime
     */
    public com.emorozov.jirabulkclone.jiraservicev2.RemoteTimeInfo getServerTime() {
        return serverTime;
    }
     ...
     * @param serverTime
     */
    public void setServerTime(com.emorozov.jirabulkclone.jiraservicev2.RemoteTimeInfo serverTime) {
        this.serverTime = serverTime;
    }

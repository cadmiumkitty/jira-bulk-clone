...
public class RemoteRoleActors  implements java.io.Serializable {
    private com.emorozov.jirabulkclone.jiraservicev2.RemoteProjectRole projectRole;

    private com.emorozov.jirabulkclone.jiraservicev2.RemoteRoleActor[] roleActors;

    private com.emorozov.jirabulkclone.jiraservicev2.RemoteUser[] users;

    public RemoteRoleActors() {
    }

    public RemoteRoleActors(
           com.emorozov.jirabulkclone.jiraservicev2.RemoteProjectRole projectRole,
           com.emorozov.jirabulkclone.jiraservicev2.RemoteRoleActor[] roleActors,
           com.emorozov.jirabulkclone.jiraservicev2.RemoteUser[] users) {
     ...
     * @return projectRole
     */
    public com.emorozov.jirabulkclone.jiraservicev2.RemoteProjectRole getProjectRole() {
        return projectRole;
    }
     ...
     * @param projectRole
     */
    public void setProjectRole(com.emorozov.jirabulkclone.jiraservicev2.RemoteProjectRole projectRole) {
        this.projectRole = projectRole;
    }
     ...
     * @return roleActors
     */
    public com.emorozov.jirabulkclone.jiraservicev2.RemoteRoleActor[] getRoleActors() {
        return roleActors;
    }
     ...
     * @param roleActors
     */
    public void setRoleActors(com.emorozov.jirabulkclone.jiraservicev2.RemoteRoleActor[] roleActors) {
        this.roleActors = roleActors;
    }
     ...
     * @return users
     */
    public com.emorozov.jirabulkclone.jiraservicev2.RemoteUser[] getUsers() {
        return users;
    }
     ...
     * @param users
     */
    public void setUsers(com.emorozov.jirabulkclone.jiraservicev2.RemoteUser[] users) {
        this.users = users;
    }

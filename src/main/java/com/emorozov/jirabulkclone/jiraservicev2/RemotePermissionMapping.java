...
public class RemotePermissionMapping  implements java.io.Serializable {
    private com.emorozov.jirabulkclone.jiraservicev2.RemotePermission permission;

    private com.emorozov.jirabulkclone.jiraservicev2.RemoteEntity[] remoteEntities;

    public RemotePermissionMapping() {
    }

    public RemotePermissionMapping(
           com.emorozov.jirabulkclone.jiraservicev2.RemotePermission permission,
           com.emorozov.jirabulkclone.jiraservicev2.RemoteEntity[] remoteEntities) {
     ...
     * @return permission
     */
    public com.emorozov.jirabulkclone.jiraservicev2.RemotePermission getPermission() {
        return permission;
    }
     ...
     * @param permission
     */
    public void setPermission(com.emorozov.jirabulkclone.jiraservicev2.RemotePermission permission) {
        this.permission = permission;
    }
     ...
     */
    public com.emorozov.jirabulkclone.jiraservicev2.RemoteEntity[] getRemoteEntities() {
        return remoteEntities;
    }
     ...
     */
    public void setRemoteEntities(com.emorozov.jirabulkclone.jiraservicev2.RemoteEntity[] remoteEntities) {
        this.remoteEntities = remoteEntities;
    }
